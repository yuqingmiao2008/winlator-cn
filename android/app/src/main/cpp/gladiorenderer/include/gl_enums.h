...
static inline const char* glEnumToString(unsigned int name) {
    switch (name) {
        case 0: return "GL_NONE";
        case 1: return "GL_LUMINANCE_LEGACY";
        case 2: return "GL_LUMINANCE_ALPHA_LEGACY";
        case 3: return "GL_RGB_LEGACY";
        case 4: return "GL_RGBA_LEGACY";
